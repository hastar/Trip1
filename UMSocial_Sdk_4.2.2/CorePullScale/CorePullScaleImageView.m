...
#import "SDWebImageManager.h"//监听，图片处理
...
#warning image修改
    ...
    [[SDWebImageManager sharedManager] downloadImageWithURL:[NSURL URLWithString:imgName] options:SDWebImageLowPriority progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
        self.image = image;
    }];
